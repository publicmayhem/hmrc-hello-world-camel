...
/**
 * Unit tests for frontend, but I was not able to get a camel context working in a unit test environment,
 * within a reasonable about of time, here for illustration purposes
 */
@RunWith(CamelSpringRunner.class)
@ContextConfiguration(classes = {FrontEndRouteTest.TestConfig.class})
...
public class FrontEndRouteTest {
    ...
    public void testRoute() throws InterruptedException {
        ...
        testInput.put("firstname", "Bob");
        testInput.put("lastname", "Dylan");
        testInput.put("occupation", "Singer");
